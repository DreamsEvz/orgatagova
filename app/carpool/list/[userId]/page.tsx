import { getCarpoolsWhereUserBelongs, getUserUnFinishedCarpools } from "@/app/carpool/carpool.action";
...
export default async function Page({ params }: { params: Promise<{ userId: string }> }) {
  ...
  return <main className="flex flex-col items-center min-h-100 bg-gray-900 p-6">
    ...
    <CarpoolUserSwap ownedCarpools={ownedCarpools} joinedCarpools={joinedCarpools} />
